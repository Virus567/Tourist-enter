...
namespace TouristСenterLibrary.Migrations
{
    ...
    [Migration("20220108124134_AddCountableHikeEquipment")]
    partial class AddCountableHikeEquipment
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CountableEquipmentHike", b =>
                {
                    b.Property<int>("CountableEquipmentsListID")
                        .HasColumnType("integer");

                    b.Property<int>("HikesListID")
                        .HasColumnType("integer");

                    b.HasKey("CountableEquipmentsListID", "HikesListID");
            ...
            modelBuilder.Entity("CountableEquipmentHike", b =>
                {
                    b.HasOne("TouristСenterLibrary.Entity.CountableEquipment", null)
                        .WithMany()
                        .HasForeignKey("CountableEquipmentsListID")
